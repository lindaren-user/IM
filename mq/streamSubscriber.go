...
type StreamSubscriber struct {
	...
	group     string
	consumer  string
	onMessage func(*dto.MessageRespDto)
...
func NewStreamSubscriber(rdb *redis.Client, stream string, group string, consumer string, handler func(*dto.MessageRespDto)) *StreamSubscriber {
